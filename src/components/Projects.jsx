...
import centreaaLogo from '../assets/E6215F89-405C-4D35-9FD6-AE6C7139D521.jpg';
...
const PROJECTS = [
  ...
  },
  {
    id: 2,
    title: "Centreaa",
    role: "Centre Médico-Sportif",
    tag: "tag-ocean",
    description: "Une plateforme digitale immersive pour un centre médico-sportif pluridisciplinaire. Présentation claire des spécialités (kinésithérapie, réathlétisation, thérapies manuelles), valorisation de l'équipe et prise de contact fluide.",
    link: "https://www.centreaa.com",
    image: centreaaLogo,
    bg: "#050505",
    fit: "contain",
  },
  ...
  return (
    ...
    >
      ...
      <div style={{
        ...
        backgroundColor: project.bg || '#F8FAFC',
        width: '100%',
      }}
      ...
      >
        <div style={{
          ...
          backgroundColor: project.bg || '#F8FAFC',
          padding: project.fit === 'contain' ? '2.5rem' : 0,
        }}>
          <img 
            src={project.image} 
            alt={project.title}
